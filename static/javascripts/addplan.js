...
function getInputTag() {
    ...
    var elements = '<div class="mb-3">\
                        <input type="text" class="form-control post-form-control autocomplete" id="autocomplete_' + placeCount + '" name="place_' + placeCount + '"placeholder="場所を入力し、選択して下さい" required>\
