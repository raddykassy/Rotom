...
def index():
    ...
    response = requests.get(f'https://api.thumbnail.ws/api/ab0497fc35234f487b2570a656c6447bb9ac44b30604/thumbnail/get?url=https%3A%2F%2Fthumbnail.ws%2F&width=800').json()
