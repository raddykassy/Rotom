...
const clientRect = document.querySelector(".trip-route");
console.log(clientRect);

const rect = clientRect.getBoundingClientRect() ;
const px = window.pageXOffset + clientRect.left ;
const py = window.pageYOffset + clientRect.top ;
const bottom = window.pageYOffset + clientRect.bottom ;
