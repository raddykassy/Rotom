...
function butotnClick(){
    ...
    tmp_data["price_li"] = rating_li
    tmp_data["url_li"] = rating_li
...
function sendData(data) {
    ...
    for (const [name, value] of Object.entries(data)) {
      ...
      for (const [name_2, value_2] of value) {
        urlEncodedDataPairs.push(`${encodeURIComponent(name_2)}=${encodeURIComponent(value_2)}`);
      }
      console.log(name)
    }
