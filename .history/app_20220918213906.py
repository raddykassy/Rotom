...
def plan_content(user_id, post_id):
    ...
    # for index, place_info in enumerate(place_info_li):
        ...
        # place_info_li[index]["lat"] = #緯度
        # place_info_li[index]["lng"] = #経度
    response = requests.get('https://maps.googleapis.com/maps/api/place/details/json?place_id=ChIJrTLr-GyuEmsRBfy61i59si0&key=AIzaSyDSB9wJUooZ1GlQFPqjUUBZmFLp7Y04HzI')
